-- Material 3 colour palette (converted from scheme/current.conf).
-- Values are bare 6-digit hex strings (no leading '#'); callers append an
-- 8th-digit alpha pair where needed, e.g. "rgba(" .. colors.surface .. "d4)".
